...
from src.models.agent import AgentCreate, AgentInfo, AgentWithStats, AgentUpdate
...
class AgentRepository(BaseRepository[AgentInfo]):
    ...
    def check_limits(self, agent_id: str) -> dict[str, Any]:
        ...
        if agent.max_monthly_tokens > 0 and agent.tokens_used_this_month >= agent.max_monthly_tokens:
            return {
                "allowed": False,
